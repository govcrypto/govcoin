...
Intro
-----
GOV (GOV) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. GOV utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run gov-qt.exe.

GOV Core is the original GOV client and it builds the backbone of the network.
However, it downloads and stores the entire history of GOV transactions;
