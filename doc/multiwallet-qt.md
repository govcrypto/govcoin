...
In order to support loading of multiple wallets in gov-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gov.cpp.
...
Changes to gov.cpp
----------------------
gov.cpp is the entry point into gov-qt, and as such, will require some minor modifications to provide hooks for
