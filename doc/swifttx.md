...
This mechanism has been integrated into Bitcore-Node-GOV which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gov/insight-api-gov#web-socket-api](https://github.com/gov/insight-api-gov#web-socket-api)
* API: [https://github.com/gov/insight-api-gov#swifttx-transactions](https://github.com/gov/insight-api-gov#swifttx-transactions)
...
By default, the GOV Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GOV Core daemon:
