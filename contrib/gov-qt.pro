...
RESOURCES += src/qt/gov.qrc src/qt/gov_locale.qrc

TRANSLATIONS += src/qt/locale/gov_bg.ts \
                src/qt/locale/gov_de.ts \
                src/qt/locale/gov_en.ts \
                src/qt/locale/gov_es.ts \
                src/qt/locale/gov_fi.ts \
                src/qt/locale/gov_fr.ts \
                src/qt/locale/gov_it.ts \
                src/qt/locale/gov_ja.ts \
                src/qt/locale/gov_pl.ts \
                src/qt/locale/gov_pt.ts \
                src/qt/locale/gov_ru.ts \
                src/qt/locale/gov_sk.ts \
                src/qt/locale/gov_sv.ts \
                src/qt/locale/gov_vi.ts \
                src/qt/locale/gov_zh_CN.ts \
                src/qt/locale/gov_zh_TW.ts
