...
#if defined(NDEBUG)
#error "GOV cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ugov) are considered zero fee (for relaying and mining)
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // GOV: We use certain sporks during IBD, so check to see if they are
