                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GOV Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GOV address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gov: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GOV Core"), this);
    aboutAction->setStatusTip(tr("Show information about GOV Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GOV"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GOV addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GOV addresses"));
    ...
    openAction->setStatusTip(tr("Open a gov: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GOV Core help message to get a list with possible GOV command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GOV Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GOV network", "", count));
}
...
{
    QString strTitle = tr("GOV Core"); // default title
