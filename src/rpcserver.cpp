...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GOV features */
        {"gov", "masternode", &masternode, true, true, false},
        {"gov", "listmasternodes", &listmasternodes, true, true, false},
        {"gov", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gov", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gov", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gov", "masternodedebug", &masternodedebug, true, true, false},
        {"gov", "startmasternode", &startmasternode, true, true, false},
        {"gov", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gov", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gov", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gov", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gov", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gov", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gov", "mnbudget", &mnbudget, true, true, false},
        {"gov", "preparebudget", &preparebudget, true, true, false},
        {"gov", "submitbudget", &submitbudget, true, true, false},
        {"gov", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gov", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gov", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gov", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gov", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gov", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gov", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gov", "checkbudgets", &checkbudgets, true, true, false},
        {"gov", "mnsync", &mnsync, true, true, false},
        {"gov", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> gov-cli " + methodname + " " + args + "\n";
}
