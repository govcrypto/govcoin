...
#   c) node1 mines 32 blocks, so now node 0 has 500000GOV, node 1 has 4250GOV, node2 has none.
#   d) node0 sends 601 GOV to node2, in two transactions (301 GOV, then 300 GOV).
