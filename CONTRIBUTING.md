Contributing to GOV Core
==================================

The GOV Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GOV Core project, and is not to be
confused with overall GOV Network Protocol consensus changes.

Whether a pull request is merged into GOV Core rests with the project merge
...
Patches that change GOV consensus rules are considerably more involved than
...
Where a patch set proposes to change the GOV consensus, it must have been
...
The project leader is the release manager for each GOV Core release.
